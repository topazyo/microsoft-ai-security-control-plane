...
|---|---|---|---|
| OWASP Top 10 for LLM Applications | **2025 edition (v2.0**, published 2024-11-18 by the OWASP GenAI Security Project**)** | [genai.owasp.org/llm-top-10](https://genai.owasp.org/llm-top-10/) · [2025 resource page](https://genai.owasp.org/resource/owasp-top-10-for-llm-applications-2025/) | 2026-07-03 |
| MITRE ATLAS | ATLAS knowledge base (technique IDs verified against MITRE's published `atlas-data` dataset, dist v5.6.0) | [atlas.mitre.org](https://atlas.mitre.org/) — technique pages [AML.T0051](https://atlas.mitre.org/techniques/AML.T0051), [AML.T0057](https://atlas.mitre.org/techniques/AML.T0057) | 2026-07-03 |
| NIST AI 600-1 | *Artificial Intelligence Risk Management Framework: Generative Artificial Intelligence Profile*, July 2024 | [nvlpubs.nist.gov/nistpubs/ai/NIST.AI.600-1.pdf](https://nvlpubs.nist.gov/nistpubs/ai/NIST.AI.600-1.pdf) · [doi.org/10.6028/NIST.AI.600-1](https://doi.org/10.6028/NIST.AI.600-1) | 2026-07-03 |
...
- OWASP item numbers verified against the OWASP GenAI Security Project's published 2025 list on 2026-07-03; re-confirm against `genai.owasp.org` at each refresh.
- MITRE ATLAS technique IDs and names verified against MITRE's published `atlas-data` dataset (dist v5.6.0) on 2026-07-03; the live technique pages on `atlas.mitre.org` use the `/techniques/<ID>` paths cited above.
- NIST AI 600-1 verified against the official PDF fetched from nvlpubs.nist.gov (full text) on 2026-07-03.
- CSA AICM verified two ways on 2026-07-03: version, scope, and availability against the CSA artifact page; item-level control IDs, titles, domains, and the 247/18 counts directly against the official AICM v1.1.0 spreadsheet.
